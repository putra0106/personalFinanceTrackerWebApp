  ...
  data.forEach((item) => {
    ...
    <tr class="border-b hover:bg-gray-50 transition">
      ...
      <td class="px-4 py-3 text-center">
        <button class="delete-income bg-red-500 hover:bg-red-600 transition px-3 py-1.5 text-sm text-white rounded-lg shadow-sm" data-id="${item.id}">
          Delete
        </button>
      </td>
    </tr>`;
